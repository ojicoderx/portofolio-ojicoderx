...
const SideBar = () => {
  ...
  return (
    <div
      className={`fixed z-50 m-0 flex w-20 flex-col bg-neutral-200/50 py-2 text-neutral-800 shadow-sm backdrop-blur-sm transition-all duration-300 ease-in-out  dark:bg-zinc-800/50 dark:text-neutral-200  sm:top-2/4 sm:h-[500px] sm:max-h-[80%] sm:-translate-y-2/4  sm:rounded-2xl ${
        !isOnLeft

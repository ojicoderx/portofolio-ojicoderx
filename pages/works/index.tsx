    ...
    >
      ...
      <div className="flex w-full flex-col items-center">
        <div className="mb-2 mt-3 flex w-full">
          ...
          <h3 className="mx-2 w-fit text-xl font-bold dark:text-neutral-200 text-neutral-800">-</h3>
        ...
        <motion.div ref={worksContainerRef} className="scrollbar flex w-full snap-x snap-mandatory overflow-x-auto py-4">
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-col content-center items-center">
        <motion.h1 variants={{ hover: { scale: 1.05 } }} className="text-center text-4xl font-bold dark:text-neutral-200 text-neutral-800">
          {title}
        </motion.h1>
